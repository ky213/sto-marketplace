...
export const UserSettingDeleteDialog = (props: IUserSettingDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="exchangeApp.userSetting.delete.question">Are you sure you want to delete this UserSetting?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="jhi-confirm-delete-userSetting" color="danger" onClick={confirmDelete}>
